...
- 스테이지 생성은 고정 단조 타깃 대신, `20스테이지 단위` 확률 윈도우를 사용한다.
- 윈도우는 `[easy, mid, hard]`와 가중치 `50/30/20`을 사용하고, 스테이지가 올라가면 윈도우가 한 칸씩 상승한다.
- 예시: 1~20은 `1/2/3`을 `50/30/20`, 21~40은 `2/3/4`를 `50/30/20`.
